@php
    $bioProfile = session('bio_profile', []);
    $profileSummary = data_get($bioProfile, 'profile', []);
    $headerFullName = data_get($profileSummary, 'Name')
        ?: data_get(session('api_user'), 'name')
        ?: 'User';
    $headerEmail = data_get($profileSummary, 'Email')
        ?: data_get(session('api_user'), 'email');
    $headerAvatar = data_get($bioProfile, 'avatar');
@endphp
            ...
            <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('tailadmin/src/images/user/user-02.jpg') }}"
                      alt="User"
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('tailadmin/src/images/user/user-03.jpg') }}"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('tailadmin/src/images/user/user-04.jpg') }}"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('tailadmin/src/images/user/user-05.jpg') }}"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
      ...
      >
        ...
        >
          <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
            @if ($headerAvatar)
                <img src="{{ $headerAvatar }}" alt="User avatar" class="h-11 w-11 object-cover" />
            @else
                <img src="{{ asset('tailadmin/src/images/user/owner.jpg') }}" alt="User avatar" />
            @endif
          </span>
